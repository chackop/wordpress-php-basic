 ...
 */
/*
Plugin Name: Holmes, Explain!
Plugin URI: http://wordpress.org/plugins/hello-dolly/
Description: This is not just a plugin, it symbolizes the hope and enthusiasm of an entire generation summed up in two words sung most famously by Louis Armstrong: Hello, Dolly. When activated you will randomly see a lyric from <cite>Hello, Dolly</cite> in the upper right of your admin screen on every page.
Author: Joe Casabona
Version: 1.0
Author URI: htts:casabona.org
*/

function holmes_get_lyric()
{
	/** These are lines from The Adventures of Sherlock Holmes */
	$lyrics = "One night—it was in June, ’89—there came a ring to my bell, about the hour when a man gives his first yawn and glances at the clock. 
...
function holmes()
{
	...
	printf(
		...
		__('Quote from Sherlock Holmes', 'hello-dolly'),
		$lang,
		$chosen
	);
}
